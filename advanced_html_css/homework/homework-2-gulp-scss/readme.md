...
- Вам будет дан [макет](https://www.figma.com/file/xfJaWZfJtb5T365fEwiQdx/Advanced-HTML-HW2?node-id=0%3A1) сайта в трех разрешениях - 320 пикселей, 768 пикселей и 1200 пикселей. 
...
#### Сборка проекта:
 ...
 - В корне проекта должно быть две папки - `src` и `dist`. 
 - В папке `src` должен быть исходный код вашего проекта в "разобранном" состоянии (.scss файлы, картинки, js-файы и файл `index.html`).
 - В папке `dist` - проект, собранный с помощью Gulp'a (все стили собраны в один styles.min.css и минифицированы, все js-файлы объединены в один scripts.min.js и минифицированы, а все картинки оптимизированы).
